<template>
    <div class="cart">
        ...
        <div class="cartMain">
             <ul>
                <li v-for="(cart,index) in carts" class="cartList">
                    <div class="cartImage">
                        <img v-bind:src="cart.pic" >
                    </div>

                    <!-- 购物车商品信息 -->
                    <div class="cartInformation">
                        <div class="cartName">{{cart.name}}
                            <a href="javascript:;" class="iconfont icon-huishouzhan7" @click="remove(index)"></a>
                        </div>
                    ...
                    <div class="cartNumber">
                        ...
                        <input type="text"   :value="cart.num" readonly="readonly"/>
        ...
        <div class="cartFooter"  v-if="carts.length">
            <div class="Total">合计：<span style="font-size: 0.54rem;color:#E3211E">￥{{total }}</span></div>
            <div class="_box">
                <div class="Settlement">
                    <a href="javascript:void(0);" @click="clear">清空购物车</a>
                </div>
